...
/*
* Notice, the images' href requires the total path length up to HTML page level.
*/
    ...
    <svg width="400" height="200">
        ...
        <defs>
          <pattern id='img_arw_U' width="1" height="1" viewBox="0 0 100 100" preserveAspectRatio="none">
            <image href='././App/Controller/Images/Arrow_U.png' width="100" height="100" preserveAspectRatio="none"></image>
          </pattern>

          <pattern id='img_arw_L' width="1" height="1" viewBox="0 0 100 100" preserveAspectRatio="none">
            <image href='././App/Controller/Images/Arrow_L.png' width="100" height="100" preserveAspectRatio="none"></image>
          </pattern>

          <pattern id='img_arw_R' width="1" height="1" viewBox="0 0 100 100" preserveAspectRatio="none">
            <image href='././App/Controller/Images/Arrow_R.png' width="100" height="100" preserveAspectRatio="none"></image>
          </pattern>

          <pattern id='img_arw_D' width="1" height="1" viewBox="0 0 100 100" preserveAspectRatio="none">
            <image href='././App/Controller/Images/Arrow_D.png' width="100" height="100" preserveAspectRatio="none"></image>
          </pattern>

          <pattern id='img_start_B' width="1" height="1" viewBox="0 0 100 100" preserveAspectRatio="none">
            <image href='././App/Controller/Images/Flash.png' width="100" height="100" preserveAspectRatio="none"></image>
          </pattern>

          <pattern id='img_stop_B' width="1" height="1" viewBox="0 0 100 100" preserveAspectRatio="none">
            <image href='././App/Controller/Images/FlashExclamantion.png' width="100" height="100" preserveAspectRatio="none"></image>
          </pattern>
        </defs>
